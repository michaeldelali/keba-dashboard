        ...
        <Card className="theme-settings">
          <Card.Body className="pt-4">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
              <p className="m-0 mb-1 me-3 fs-7">Made with gratitude <span role="img" aria-label="gratitude">💙</span></p>
              <GitHubButton href="#" data-size="large" data-show-count="true" aria-label="Star themesberg/volt-react-dashboard on GitHub">Star</GitHubButton>
            </div>
